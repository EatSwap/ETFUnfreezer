...
public class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (nms.equals("v1_17_R1")) {
            ...
            pm.registerEvents(new MC1_17_R1(), this);
            Bukkit.getLogger().info("[ETFUnfreezer] Enabled successfully.");
        } else {
            Bukkit.getLogger().info("[ETFUnfreezer] Unsupported version " + nms +". Plugin will be disabled.");
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String label, String[] args) {
        ...
        if(args[0].equalsIgnoreCase("unfreeze")) {
            ...
            if (args[1].equalsIgnoreCase("area")){
                ...
                MC1_17_R1.AIEntitiesArea(args[2], Objects.requireNonNull(((Player) commandSender).getPlayer()), Objects.requireNonNull(((Player) commandSender).getPlayer()));
                return true;
            }
            ...
            if (args[1].equalsIgnoreCase("player")){
                ...
                if (args[2].equalsIgnoreCase("all") || args[2].equalsIgnoreCase("*")) {
                    MC1_17_R1.AIAllPlayersNearEntities(((Player) commandSender).getPlayer());
                    return true;
                }
                ...
                MC1_17_R1.AIEntitiesArea("300", player, Objects.requireNonNull(((Player) commandSender).getPlayer()));
                return true;
            }
        ...
        if(args[0].equalsIgnoreCase("freeze")) {
            ...
            if (args[1].equalsIgnoreCase("area")) {
                ...
                MC1_17_R1.DisableAIEntitiesArea(args[2], Objects.requireNonNull(((Player) commandSender).getPlayer()));
                return true;
            }
